      ...
      <header className="py-4 border-b border-gray-100 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tight">שישי שיתופי</span>
          </div>
          <Link
            to="/login"
      ...
      <main className="flex-grow">
        ...
        <section className="pt-16 pb-8 px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 mb-6 leading-tight">
              ניהול ארוחות קהילתיות <span className="text-orange-500">בקלות</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              הפלטפורמה שהופכת את התיאום הלוגיסטי לחוויה חלקה, כדי שתוכלו להתרכז באוכל ובחיבור האנושי.
            </p>
            <Link
              to="/login"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8 order-2 md:order-1">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">מתאים לכל מפגש</h3>
                <ul className="space-y-6">
                  {[
                    'פיקניקים משפחתיים בפארק',
                    'טיולי חברים וקמפינג',
                    'ארוחות שבת וחג קהילתיות',
                    'מסיבות משרד ואירועי חברה'
                  ].map((item, idx) => (
              ...
              <div className="order-1 md:order-2 bg-gradient-to-br from-orange-50 to-white border border-orange-100 rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-lg shadow-orange-100/50">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    היתרון הגדול שלנו הוא בפשטות:
                    <br />
                    <strong className="text-orange-700 text-xl block mt-4 mb-2">
                      המשתתפים לא צריכים להירשם!
                    </strong>
                    פשוט שולחים להם לינק, הם בוחרים מה להביא, וזהו. <br />בלי סיסמאות, בלי הורדות ובלי כאב ראש.
                  </p>
                </div>
              </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-3xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-10 text-center">למה בנינו את זה?</h2>
            <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
              <div className="prose prose-lg mx-auto text-gray-700 rtl:text-right">
                <p>
                  "לפעמים הרעיונות הכי טובים נולדים לא במשרד, אלא סביב שולחן שבת.
                  כמי שיצא בשאלה ומשתתף בארוחות קהילתיות, חוויתי את הקסם של הארוחות השיתופיות - אבל גם את הכאב ראש הלוגיסטי."
                </p>
                <p>
                  "ניהול ה'מי מביא מה' דרך Google Sheets היה מסורבל, לא מותאם לנייד וגרר תקלות. מישהו מחק בטעות שורה, אחרים הסתבכו עם העריכה בטלפון, ומנהלת האירוע עבדה קשה מדי."
                </p>
                <p className="font-bold text-orange-600">
                  "שישי שיתופי נולד כדי לפתור בדיוק את זה. בנינו פתרון ייעודי שמייצר חוויה חלקה, אפס תקלות ושקט נפשי למנהלי האירוע."
                </p>
              </div>
            </div>
          </div>
